...
class AlergiObatTetesMataScreen extends StatelessWidget {
  const AlergiObatTetesMataScreen({Key? key}) : super(key: key);

  final List<String> tandaBahaya = const [
    'Nyeri; Sensasi panas atau terbakar pada mata setelah diberikan obat tetes.',
    'Bengkak; Kelopak mata membengkak dan terasa tidak nyaman.',
    'Mata Merah; Mata menjadi merah disertai rasa perih atau panas.',
    'Mata Berair; Mata mengeluarkan lendir atau air berlebihan.',
    'Penglihatan Kabur; Penglihatan menjadi tidak jelas atau buram.',
    'Sensasi Benda Asing; Merasa ada sesuatu yang mengganjal di mata.',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tanda Bahaya Alergi Obat Tetes Mata', style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    'Kenali tanda-tanda bahaya berikut setelah menggunakan obat tetes mata:',
